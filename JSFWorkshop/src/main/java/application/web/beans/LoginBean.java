...
import application.domain.models.binding.UserLoginBindingModel;
...
public class LoginBean extends BaseBean {
    ...
    public void login() {
        UserServiceModel user = this.userService.findUserByUandP(this.user.getUsername(), DigestUtils.sha256Hex(this.user.getPassword()));
